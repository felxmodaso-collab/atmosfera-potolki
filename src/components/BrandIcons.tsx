...
export function MaxIcon({ size = 18, className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" className={className} aria-hidden>
      <circle cx="12" cy="12" r="11.2" fill="none" stroke="currentColor" strokeWidth="1.6" />
      <path d="M6.4 17 V7.4 H8.7 L12 13 L15.3 7.4 H17.6 V17 H15.6 V11 L12.6 16 H11.4 L8.4 11 V17 Z" fill="currentColor" />
    </svg>
  );
}
...
export function PhoneIcon({ size = 18, className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" className={className} aria-hidden>
      <path d="M20 15.5c-1.25 0-2.45-.2-3.57-.57-.35-.11-.74-.03-1.02.24l-2.2 2.2a15.07 15.07 0 0 1-6.59-6.59l2.2-2.2c.27-.28.36-.67.24-1.02A11.36 11.36 0 0 1 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1z"/>
    </svg>
  );
}
